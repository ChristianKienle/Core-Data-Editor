...
- (void)beginSheetModalForWindow:(NSWindow *)window completionHandler_oa:(OAAlertSheetCompletionHandler)completionHandler;
{
...
void OABeginAlertSheet(NSString *title, NSString *defaultButton, NSString *alternateButton, NSString *otherButton, NSWindow *docWindow, OAAlertSheetCompletionHandler completionHandler, NSString *msgFormat, ...)
{
    ...
    [alert beginSheetModalForWindow:docWindow completionHandler_oa:completionHandler];
